---
title: "[Service Validation] meshnet - Validation and Testing"
labels: 
  - service-validation
  - testing
  - network
...
# 🔍 Service Validation: meshnet

**Service Category:** 🌐 Network & Security Services  
**Service File:** `services/network/meshnet.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-meshnet`
...
docker-compose -f services/network/meshnet.yml config
