---
title: "[Service Validation] uptime-kuma - Validation and Testing"
labels: 
  - service-validation
  - testing
  - automation
...
# 🔍 Service Validation: uptime-kuma

**Service Category:** 🤖 Automation & Monitoring Services  
**Service File:** `services/automation/uptime-kuma.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-uptime-kuma`
...
docker-compose -f services/automation/uptime-kuma.yml config

# Start service
make start-uptime-kuma
