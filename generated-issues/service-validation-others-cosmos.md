---
title: "[Service Validation] cosmos - Validation and Testing"
labels: 
  - service-validation
  - testing
  - others
...
# 🔍 Service Validation: cosmos

**Service Category:** 🔧 Other Services  
**Service File:** `services/others/cosmos.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-cosmos`
...
docker-compose -f services/others/cosmos.yml config
