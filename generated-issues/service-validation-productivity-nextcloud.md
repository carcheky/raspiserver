---
title: "[Service Validation] nextcloud - Validation and Testing"
labels: 
  - service-validation
  - testing
  - productivity
...
# 🔍 Service Validation: nextcloud

**Service Category:** ☁️ Productivity & Workflow Services  
**Service File:** `services/productivity/nextcloud.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-nextcloud`
...
docker-compose -f services/productivity/nextcloud.yml config

# Start service
make start-nextcloud
