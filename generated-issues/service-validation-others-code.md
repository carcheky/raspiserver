---
title: "[Service Validation] code - Validation and Testing"
labels: 
  - service-validation
  - testing
  - others
...
**Service File:** `services/others/code.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-code`
...
docker-compose -f services/others/code.yml config
