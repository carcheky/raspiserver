---
title: "[Service Validation] cloudflared - Validation and Testing"
labels: 
  - service-validation
  - testing
  - network
...
# 🔍 Service Validation: cloudflared

**Service Category:** 🌐 Network & Security Services  
**Service File:** `services/network/cloudflared.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-cloudflared`
...
docker-compose -f services/network/cloudflared.yml config

# Start service
make start-cloudflared
