---
title: "[Service Validation] esphome - Validation and Testing"
labels: 
  - service-validation
  - testing
  - automation
...
# 🔍 Service Validation: esphome

**Service Category:** 🤖 Automation & Monitoring Services  
**Service File:** `services/automation/esphome.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-esphome`
...
docker-compose -f services/automation/esphome.yml config
