---
title: "[Service Validation] adguardhome - Validation and Testing"
labels: 
  - service-validation
  - testing
  - network
...
# 🔍 Service Validation: adguardhome

**Service Category:** 🌐 Network & Security Services  
**Service File:** `services/network/adguardhome.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-adguardhome`
...
docker-compose -f services/network/adguardhome.yml config

# Start service
make start-adguardhome

# Check logs
make logs-adguardhome
