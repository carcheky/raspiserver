---
title: "[Service Validation] sonarr - Validation and Testing"
labels: 
  - service-validation
  - testing
  - multimedia
...
# 🔍 Service Validation: sonarr

**Service Category:** 🎬 Multimedia Services  
**Service File:** `services/multimedia/sonarr.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-sonarr`
...
docker-compose -f services/multimedia/sonarr.yml config
