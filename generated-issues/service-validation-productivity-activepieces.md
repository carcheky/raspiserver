---
title: "[Service Validation] activepieces - Validation and Testing"
labels: 
  - service-validation
  - testing
  - productivity
...
# 🔍 Service Validation: activepieces

**Service Category:** ☁️ Productivity & Workflow Services  
**Service File:** `services/productivity/activepieces.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-activepieces`
...
docker-compose -f services/productivity/activepieces.yml config

# Start service
make start-activepieces

# Check logs
make logs-activepieces

# Check status
docker-compose ps activepieces
