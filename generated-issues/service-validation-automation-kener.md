---
title: "[Service Validation] kener - Validation and Testing"
labels: 
  - service-validation
  - testing
  - automation
...
# 🔍 Service Validation: kener

**Service Category:** 🤖 Automation & Monitoring Services  
**Service File:** `services/automation/kener.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-kener`
...
docker-compose -f services/automation/kener.yml config
