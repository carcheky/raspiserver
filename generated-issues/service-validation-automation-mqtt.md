---
title: "[Service Validation] mqtt - Validation and Testing"
labels: 
  - service-validation
  - testing
  - automation
...
# 🔍 Service Validation: mqtt

**Service Category:** 🤖 Automation & Monitoring Services  
**Service File:** `services/automation/mqtt.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-mqtt`
...
docker-compose -f services/automation/mqtt.yml config
