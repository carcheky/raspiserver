---
title: "[Service Validation] proxy - Validation and Testing"
labels: 
  - service-validation
  - testing
  - others
...
**Service File:** `services/others/proxy.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-proxy`
...
docker-compose -f services/others/proxy.yml config
