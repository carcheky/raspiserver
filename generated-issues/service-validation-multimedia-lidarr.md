---
title: "[Service Validation] lidarr - Validation and Testing"
labels: 
  - service-validation
  - testing
  - multimedia
...
# 🔍 Service Validation: lidarr

**Service Category:** 🎬 Multimedia Services  
**Service File:** `services/multimedia/lidarr.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-lidarr`
...
docker-compose -f services/multimedia/lidarr.yml config
