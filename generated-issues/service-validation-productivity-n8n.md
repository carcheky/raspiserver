---
title: "[Service Validation] n8n - Validation and Testing"
labels: 
  - service-validation
  - testing
  - productivity
...
# 🔍 Service Validation: n8n

**Service Category:** ☁️ Productivity & Workflow Services  
**Service File:** `services/productivity/n8n.yml`  
...
- [ ] 🚀 Service starts successfully: `make start-n8n`
...
docker-compose -f services/productivity/n8n.yml config
